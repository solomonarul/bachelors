...
\centering
\captionof{figure}{The IBM logo display running in \href{https://github.com/solomonarul/edra}{\texttt{Edra}} showing the correct result.\\}
\end{minipage}
...
\centering
\captionof{figure}{The Corax+ opcode and the flags tests running in \href{https://github.com/solomonarul/edra}{\texttt{Edra}} showing the correct result.\\}
\end{minipage}
...
\centering
\captionof{figure}{The quirks test, normal CHIP8 and modern SCHIP variants running in \href{https://github.com/solomonarul/edra}{\texttt{Edra}} showing the correct result for each of the respective platforms. \\}
\end{minipage}